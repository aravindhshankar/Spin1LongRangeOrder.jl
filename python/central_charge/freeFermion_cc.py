...
This example code evaluate the central charge of the spinful free fermion model using iDMRG.
The expected value for the central charge c = 2. The code always recycle the environment from
...
def example_DMRG_hubbard_infinite_S_xi_scaling(hx):
    model_params = dict(
        t=1.0, U=0.0, Vpp=0.0, Vpm=0.0, mu=0.0, hx=hx, hz=0.0,
        bc_MPS="infinite",
    ...
    for itern , chi in enumerate(chi_list):
        t0 = time.time()
